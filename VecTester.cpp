...
TEST_CASE("ctors") {
    ...
    SECTION("explicit-value") {
        //	Vec v1(3);
        //	REQUIRE(v1.mySize == 3);
        //	REQUIRE(v1.myArray != nullptr);
        //	for (int i = 0; i < 3; ++i) {
        //		REQUIRE(v1.myArray[i] == 0);
        //	}
        //	Vec v2(8);
        //	REQUIRE(v2.mySize == 8);
        //	REQUIRE(v2.myArray != nullptr);
        //	for (int i = 0; i < 8; ++i) {
        //		REQUIRE(v2.myArray[i] == 0);
        //	}
        //	Vec v3(0);
        //	REQUIRE(v3.mySize == 0);
        //	REQUIRE(v3.myArray == nullptr);
    }
    SECTION("copy") {
        //	Vec v1(3);
        //	REQUIRE(v1.mySize == 3);
...
//	v5 = v3;
//	REQUIRE(v5.mySize == 5);
//	REQUIRE(v5.myArray != v3.myArray);
//	for (unsigned i = 0; i < 5; ++i) {
//		REQUIRE(v5.myArray[i] == (i+1));
//	}
//	cout << " 3 " << flush;
...
//	v6 = v3;
//	REQUIRE(v6.mySize == 5);
//	REQUIRE(v6.myArray != v3.myArray);
//	for (unsigned i = 0; i < 5; ++i) {
//		REQUIRE(v6.myArray[i] == (i+1));
//	}
//	cout << " 4 " << flush;
...
//	v7 = v3;
//	REQUIRE(v7.mySize == 5);
//	REQUIRE(v7.myArray != v3.myArray);
//	for (unsigned i = 0; i < 5; ++i) {
//		REQUIRE(v7.myArray[i] == (i+1));
//	}
//	cout << " 5 " << flush;
//	// assignment chaining
//	Vec v8;
...
//	REQUIRE(v9.mySize == 5);
//	REQUIRE(v9.mySize == 5);
//	REQUIRE(v8.myArray != v3.myArray);
//	REQUIRE(v8.myArray != v3.myArray);
//	REQUIRE(v9.myArray != v8.myArray);
//	for (unsigned i = 0; i < 5; ++i) {
//		REQUIRE(v8.myArray[i] == (i+1));
//		REQUIRE(v9.myArray[i] == (i+1));
//	}
//	cout << " 6 " << flush;
//
//	cout << "Passed!" << endl;
...
//	}
//	REQUIRE(v1.myArray != saveAddress);
//	cout << " 1 " << flush;
//
...
//	}
//	REQUIRE(v2.myArray != saveAddress);
//	cout << " 2 " << flush;
//
//	// non-empty, same-size
//	Vec v3(5);
...
//	}
//	REQUIRE(v3.myArray == saveAddress);
//	cout << " 3 " << flush;
//	// set size to zero
//	v3.setSize(0);
...
//	REQUIRE(v1.myArray != nullptr);
//	REQUIRE(v1.getItem(0) == 1);
//	REQUIRE(v1.getItem(1) == 2);
//	REQUIRE(v1.getItem(2) == 3);
//	cout << " 1 " << flush;
//
//	Vec v2(5);
//	Item* oldAddr = v2.myArray;
//	v2.readFrom("vecTest2.txt");
//	REQUIRE(v2.getSize() == 4);
//	cout << " 2 " << flush;
//	REQUIRE(v2.myArray != nullptr);
//	REQUIRE(v2.getItem(0) == 2);
//	REQUIRE(v2.getItem(1) == 4);
//	REQUIRE(v2.getItem(2) == 6);
//	REQUIRE(v2.getItem(3) == 8);
/* the last REQUIREion assumes that the new array's base
 *  address is different from the old array's base address,
 *  which may not be true. If your method seems to be right,
 *  is correctly using delete to deallocate the old array,
 *  and passes all REQUIREions except this one, you may
 *  comment out this REQUIREion.
 */
//	REQUIRE(v2.myArray != oldAddr);
//	cout << " 3 " << flush;
...
//      REQUIRE(v3.getSize() == 4);
//      REQUIRE(v3.myArray != nullptr);
//      REQUIRE(v3.getItem(0) == 2);
//      REQUIRE(v3.getItem(1) == 4);
//      REQUIRE(v3.getItem(2) == 6);
//      REQUIRE(v3.getItem(3) == 8);
//      cout << " 4 " << flush;
